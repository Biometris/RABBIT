...
function magicimpute(genofile::AbstractString,
    ...
    magicimpute!(magicgeno;
        ...
        likeparameters, threshlikeparameters, threshrepeat, priorlikeparameters,
        chrsubset, snpsubset,isparallel, isparallelfounder, byfounder,isrepeatimpute, nrepeatmin, nrepeatmax, 
    ...
    if target in ["all","founder"]
        ...
        if isbinning
            ...
            magicimpute_founder!(represent_magicgeno;
                ...
                threshrepeat,            
                isdelmarker, delsiglevel, iscorrectfounder, 
        ...
        if isbinning && binriffle < 0
            ...
            magicimpute_founder!(magicgeno;
                ...
                nrepeatmin, nrepeatmax, threshrepeat,                       
                isdelmarker, delsiglevel, 
                isinferjunc, iscorrectfounder, isinfererror, tukeyfence, minoutlier,             

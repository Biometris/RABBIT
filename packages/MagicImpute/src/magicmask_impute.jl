...
function magicmask_impute(genofile::AbstractString,
    ...
    tused = @elapsed  magicimpute(masked_genofile,pedinfo;
        ...
        target, threshimpute,threshrepeat, isrepeatimpute,nrepeatmin, nrepeatmax, 
        model,  likeparameters, threshlikeparameters, priorlikeparameters,
        chrsubset, snpsubset,isparallel, byfounder,
        ...
        tukeyfence, minoutlier, isspacemarker, trimcm, trimfraction, skeletonsize, 
